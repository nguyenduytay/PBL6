"""
Domain Models - Analysis domain entities
Domain models đại diện cho business entities, không phụ thuộc vào database hay framework
"""
...
class Analysis:
    """
    Analysis Domain Model - Entity đại diện cho một lần phân tích malware
...
class YaraMatch:
    """
    YARA Match Domain Model - Entity đại diện cho một YARA rule match
